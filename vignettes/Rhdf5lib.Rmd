...
In C or C++ code files, use standard techniques, e.g., `#include "c++/hdf5.h"`. Header files can be inspected manually.  To find their location you can use the following code:
...
This work was supported by the BMBF-funded Heidelberg Center for Human Bioinformatics (HD-HuB) within the German Network for Bioinformatics Infrastructure (de.NBI), Förderkennzeichen #031A537BNils Kurzawa
